...
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/ALEKING/libreria-HUB/refs/heads/main/libreria", true))()

local window = library:AddWindow("OMEGADEZZ HUB | PAID Ultra Premiun / By HonnyDezz", {
...
Credits:AddLabel("ALEKING HUB / Script OP")
Credits:AddLabel("Script Creado por:")
Credits:AddLabel("AleKing / Colaborador DC")
